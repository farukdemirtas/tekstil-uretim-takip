          ...
          <div className="flex flex-wrap items-center gap-2">
            {hasPermission("isiCubuguKontrolu") ? (
              <Link
                ...
                className="flex items-center gap-1.5 whitespace-nowrap rounded-xl border border-orange-300 bg-white px-3 py-2 text-xs font-semibold text-orange-700 shadow-sm transition hover:bg-orange-50 sm:text-sm"
              >
                Isı Çubuğu Kontrolü
              </Link>
            ) : null}
            <button
              ...
              className="flex items-center gap-1.5 whitespace-nowrap rounded-xl border border-emerald-500 bg-emerald-600 px-3 py-2 text-xs font-semibold text-white shadow-sm transition hover:bg-emerald-700 sm:px-4 sm:text-sm"
            >
        ...
        <div className="flex flex-wrap items-end gap-3 rounded-2xl border border-slate-200/80 bg-white px-4 py-3 shadow-sm dark:border-slate-700/60 dark:bg-slate-900/80">
          ...
          <div className="flex min-w-[180px] flex-1 flex-col gap-1">
            ...
            <input
              ...
              className="w-full rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm uppercase outline-none focus:border-teal-500 dark:border-slate-600 dark:bg-slate-800 dark:text-slate-100"
            />
          </div>
          <div className="flex min-w-[180px] flex-1 flex-col gap-1">
                    ...
                    {DAY_COLUMNS.map((day) => {
                      ...
                      return (
                        <td key={day} className="border-r border-slate-100 p-0.5 text-center dark:border-slate-800">
                          {!valid ? (
                            <div className="mx-auto h-6 w-6 rounded bg-slate-100 dark:bg-slate-800/60" />
                          ) : (
                            <button
                              type="button"
                              role="checkbox"
                              ...
                              className={`mx-auto flex h-6 w-6 items-center justify-center rounded border transition active:scale-95 ${
                                checked
